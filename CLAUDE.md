...
python -m pytest tests/ -m "not browser and not complex_setup" -v  # Run CI-safe tests (555 tests)
...
python -m pytest tests/ -m "not browser and not complex_setup"    # Backend tests MUST pass
...
pytest -m "not browser and not complex_setup"  # CI-safe tests (555 tests)

...
class NormalizationRules:
    ...
    energy_mappings: Dict[str, str] = field(default_factory=lambda: {
        "moderate": "medium",
    ...
    trainability_mappings: Dict[str, str] = field(default_factory=lambda: {
    ...
    compatibility_mappings: Dict[str, Dict[str, str]] = field(default_factory=lambda: {
        "children": {
    ...
    list_constraints: Dict[str, Dict[str, Any]] = field(default_factory=lambda: {
        "personality_traits": {
            "min": 3,
            "max": 5,

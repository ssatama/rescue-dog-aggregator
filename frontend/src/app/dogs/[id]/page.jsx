              ...
              <div className="md:w-1/2">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-1 items-center">
                    <span className="text-gray-800">{dog.standardized_breed || dog.breed || 'Unknown'}</span>
                    {dog.standardized_breed && dog.breed && dog.standardized_breed !== dog.breed && (
                      <span className="text-sm text-gray-500 ml-2">(originally listed as: {dog.breed})</span>
                    )}
                  </div>
                  {dog.breed_group && dog.breed_group !== 'Unknown' && (
                    <Badge variant="secondary" className="mt-1">{dog.breed_group} Group</Badge>
                  )}
                </div>

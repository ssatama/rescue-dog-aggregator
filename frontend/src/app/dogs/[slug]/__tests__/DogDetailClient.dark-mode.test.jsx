  ...
  describe("Breadcrumb Dark Mode", () => {
    ...
    test("breadcrumb current page has dark mode styling", async () => {
      ...
      await waitFor(() => {
        ...
        const currentPageSpan = breadcrumbNav.querySelector(
  ...
  describe("Main Content Dark Mode", () => {
    ...
    test("breed section text has proper dark mode colors", async () => {
      ...
      await waitFor(() => {
        ...
        const breedText = document.querySelector(
    ...
    test("metadata card content text has dark mode colors for visibility", async () => {
      ...
      await waitFor(() => {
        ...
        const ageContent = ageCard.querySelector(
          ".text-gray-800.dark\\:text-gray-100",
        );
        ...
        const sexContent = sexCard.querySelector(
          ".text-gray-800.dark\\:text-gray-100",
        );
    ...
    test("CTA helper text has dark mode styling", async () => {
      ...
      await waitFor(() => {
        const helperText = screen.getByText(
          /you'll be redirected to the rescue organization's website/i,
        );
    ...
    test("back to dogs button has dark mode styling", async () => {
      ...
      await waitFor(() => {
        ...
        const backButtonElement = document.querySelector(
          '[class*="text-orange-500"][class*="dark:text-orange-400"]',
        );

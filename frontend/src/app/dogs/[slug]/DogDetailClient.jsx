  ...
  return (
    <ToastProvider>
      <DogDetailErrorBoundary dogSlug={dogSlug}>
        <Layout>
          <div data-testid="dog-detail-container" className="max-w-4xl mx-auto px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
            ...
            <ScrollAnimationWrapper delay={100}>
              <Link href="/dogs">
                <Button variant="link" className="inline-flex items-center text-orange-500 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 mb-6 p-2 h-auto transition-all duration-300 hover:bg-orange-50 dark:hover:bg-orange-900/20 rounded-lg focus:ring-2 focus:ring-orange-500 focus:ring-offset-2" data-testid="back-button">
                  ← Back to all dogs
                </Button>
              </Link>
            </ScrollAnimationWrapper>
                  ...
                  <div className="w-full">
                    ...
                    <ScrollAnimationWrapper delay={600}>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-8" data-testid="metadata-cards">
                        ...
                        <div className="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-4 text-center transform transition-all duration-300 hover:scale-105 hover:shadow-md border border-orange-100 dark:border-orange-800/30" data-testid="dog-sex-card">
                        ...
                        <div className="mb-8" data-testid="cta-section">
                          <div className="flex justify-center">
                            <Button asChild className="w-full sm:w-auto sm:min-w-[280px] sm:max-w-[400px] bg-orange-600 dark:bg-orange-600 hover:bg-orange-700 dark:hover:bg-orange-700 text-white text-lg py-4 px-8 shadow-lg hover:shadow-xl transition-all duration-300 rounded-lg transform hover:scale-105 focus:ring-4 focus:ring-orange-500 focus:ring-offset-2">
                              <a href={dog.adoption_url} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center" data-testid="adopt-button">
                                <svg 

...
import { sanitizeText, safeExternalUrl } from "../../../utils/security";
            ...
            <div className="p-4 sm:p-6 relative">
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="w-full">
                  ...
                  <section aria-label="About the Dog">
                    <div className="mb-8" data-testid="about-section">
                      ...
                      <DogDescription
                        description={
                          dog?.llm_description ||
                          (typeof dog?.properties?.description === "string"
                            ? dog.properties.description
                            : undefined) ||
                          (typeof dog?.properties?.raw_description === "string"
                  ...
                  {hasAnyProfileSection(dog.dog_profiler_data) && (
                    <ScrollAnimationWrapper delay={750}>
                      <section
                        aria-label="Personality and Behavioral Information"
                        className="mb-8 space-y-6"
                      >
                        {/* Each heading is gated by the same predicate its
                              component uses, so a heading can never render
                              above an empty body. */}
                    ...
                    <ScrollAnimationWrapper delay={850}>
                      <div className="mb-8" data-testid="cta-section">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 text-center mt-3 transition-colors duration-200">
                          You&apos;ll be redirected to the rescue

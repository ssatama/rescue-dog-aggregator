...
describe('Dynamic Robots.txt Route', () => {
  ...
  test('should generate robots.txt for production environment', async () => {
    ...
    expect(response.body).toContain('Sitemap: https://rescuedogs.me/sitemap.xml');
  ...
  test('should generate robots.txt for development environment', async () => {
    ...
    expect(response.body).toContain('Sitemap: http://localhost:3000/sitemap.xml');
  ...
  test('should use custom base URL from environment', async () => {
    ...
    expect(response.body).toContain('Sitemap: https://staging.rescuedogs.me/sitemap.xml');
  });

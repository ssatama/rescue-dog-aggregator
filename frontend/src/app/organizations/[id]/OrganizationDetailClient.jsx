            ...
            <div className="space-y-2">
              {organization.properties.email && (
                <div className="flex items-center">
                  ...
                  <a href={`mailto:${organization.properties.email}`} className="text-orange-500 hover:underline">
                    {organization.properties.email}
                  </a>
                </div>
              )}
              ...
              {organization.properties.phone && (
                <div className="flex items-center">
                  ...
                  <a href={`tel:${organization.properties.phone}`} className="text-orange-500 hover:underline">
                    {organization.properties.phone}
                  </a>
                </div>
              )}

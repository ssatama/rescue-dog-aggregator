    ...
    <Layout>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-section text-gray-800 dark:text-gray-200 mb-4">Our Mission</h2>
        ...
        <section className="mb-12 bg-gray-50 dark:bg-gray-800 p-8 rounded-lg">
          <h2 className="text-section text-gray-800 dark:text-gray-200 mb-6 text-center">How It Works</h2>
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-4xl mb-2">🐾</div> {/* Placeholder Icon */}
              <h3 className="text-card-title text-gray-900 dark:text-gray-100 mb-2">1. Browse Dogs</h3>
              <p className="text-body text-gray-600 dark:text-gray-400">
            ...
            <div>
              ...
              <h3 className="text-card-title text-gray-900 dark:text-gray-100 mb-2">2. View Details</h3>
              <p className="text-body text-gray-600 dark:text-gray-400">
            ...
            <div>
              <div className="text-4xl mb-2">🏠</div> {/* Placeholder Icon */}
              <h3 className="text-card-title text-gray-900 dark:text-gray-100 mb-2">3. Connect & Adopt</h3>
              <p className="text-body text-gray-600 dark:text-gray-400">
        ...
        <section className="text-center">
          <h2 className="text-section text-gray-800 dark:text-gray-200 mb-4">Get Involved</h2>

...
export default function TestImages(): React.JSX.Element {
  ...
  const handleImageErrorWithLog = (e: React.SyntheticEvent<HTMLImageElement>, originalUrl: string | null): void => {
    const error = `Image failed to load: ${e.currentTarget.src}`;
            ...
            <div key={index} className="border rounded p-4">
              ...
              <div className="mb-4">
                ...
                <HeroImageWithBlurredBackground
                  ...
                  alt={`Test ${test.name}`}
                  onError={() => addLog(`Hero image error: ${test.name}`)}
              ...
              <div>
                ...
                <LazyImage
                  ...
                  onError={(e: React.SyntheticEvent<HTMLImageElement>) => handleImageErrorWithLog(e, test.url)}
        ...
        <button
          onClick={async () => {
            try {
              ...
              addLog(`Fetch error: ${error instanceof Error ? error.message : String(error)}`);
            }
          }}

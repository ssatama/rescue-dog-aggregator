    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[200px] flex items-center justify-center p-4 dark:bg-gray-900/50">
          <Alert variant="destructive" className="max-w-lg bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800/30">
            <AlertTitle className="text-red-800 dark:text-red-200">Something went wrong</AlertTitle>

...
describe('DogDetailErrorBoundary', () => {
  ...
  it('should render children when no error occurs', () => {
    ...
    expect(screen.queryByTestId('dog-detail-error-boundary')).not.toBeInTheDocument();
  });
  ...
  it('should render error UI when child component throws error', () => {
    ...
    expect(screen.getByText(/We're having trouble loading this dog's information/)).toBeInTheDocument();
  });
  ...
  it('should show helpful suggestions section', () => {
    ...
    expect(screen.getByText('• Browse other available dogs')).toBeInTheDocument();
    expect(screen.getByText('• Search by breed or location')).toBeInTheDocument();
    expect(screen.getByText('• Learn about our rescue partners')).toBeInTheDocument();
  });
...
describe('DogDetailErrorBoundary accessibility', () => {
  ...
  it('should have proper ARIA labels and roles', () => {
    ...
    expect(screen.getByRole('link', { name: /browse all dogs/i })).toBeInTheDocument();
  });

...
describe('HeroSection', () => {
  ...
  describe('Loading states', () => {
    test('should show loading skeleton while fetching statistics', () => {
      ...
      expect(screen.queryByTestId('statistics-content')).not.toBeInTheDocument();
    });
  ...
  describe('Error handling', () => {
    ...
    test('should handle empty statistics gracefully', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('No organizations currently available')).toBeInTheDocument();
      });
    });
  });
  ...
  describe('Accessibility', () => {
    ...
    test('should have proper ARIA labels for statistics', async () => {
      ...
      await waitFor(() => {
        const counters = screen.getAllByTestId('animated-counter');
        expect(counters[0]).toHaveAttribute('aria-label', 'Dogs need homes: 412');
        expect(counters[1]).toHaveAttribute('aria-label', 'Rescue organizations: 3');

...
describe("FeaturedDogsSection", () => {
  ...
  describe("Section Header", () => {
    ...
    test("should render meta text with correct count", () => {
      ...
      expect(
        screen.getByText("Showing 6 of 2,500 available dogs"),
      ).toBeInTheDocument();
    });
    ...
    test("should format large numbers with commas", () => {
      ...
      expect(
        screen.getByText("Showing 6 of 3,186 available dogs"),
      ).toBeInTheDocument();
    });
  ...
  describe("Edge Cases", () => {
    test("should handle empty dogs array", () => {
      ...
      expect(
        screen.getByText("Showing 6 of 0 available dogs"),
      ).toBeInTheDocument();
    });

...
describe("BreedsCTA", () => {
  ...
  describe("Desktop View", () => {
    ...
    it("renders desktop headline and subheadline", () => {
      ...
      expect(
        screen.getByText(/Our new breed explorer reveals personality insights/),
      ).toBeInTheDocument();
    });
  ...
  describe("Mobile View", () => {
    ...
    it("renders mobile-optimized headline", () => {
      ...
      expect(
        screen.getByText("NEW: Breed Personality Insights"),
      ).toBeInTheDocument();
    });
    ...
    it("displays compact CTA button on mobile", () => {
      ...
      const ctaButton = screen.getByRole("button", {
        name: /Discover Breeds and explore personality insights/i,
      });
      expect(ctaButton).toBeInTheDocument();
    ...
    it("has proper ARIA labels", () => {
      ...
      expect(
        screen.getByRole("region", {
          name: /Breed Discovery and Personality Insights/i,
        }),
      ).toBeInTheDocument();
      expect(
      ...
      expect(
        screen.getByRole("region", { name: /Breed Discovery/i }),
      ).toBeInTheDocument();
      expect(
        screen.getByRole("button", {
          name: /Discover Breeds and explore personality insights/i,

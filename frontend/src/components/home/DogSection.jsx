    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-end mb-8">
          <div>
            <h2 id={titleId} className="text-section text-foreground mb-2" data-testid="dog-section-title">
              {title}
            </h2>
        ...
        <div className={`transition-opacity duration-300 ${loading ? 'opacity-100' : 'opacity-0 pointer-events-none absolute'}`} data-testid="dog-section-loading">
        ...
        {/* Error State */}
        {error && !loading && (
          <Alert variant="destructive" className="max-w-2xl mx-auto" data-testid="dog-section-error">

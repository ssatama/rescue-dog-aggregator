      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-card rounded-lg shadow-sm hover:shadow-md dark:shadow-purple-500/10 hover:dark:shadow-purple-500/20 transition-shadow duration-200 p-6 text-center">
            ...
            <div className="text-4xl font-bold text-foreground mb-2" data-testid="organizations-stat">
          ...
          <div className="bg-card rounded-lg shadow-sm hover:shadow-md dark:shadow-purple-500/10 hover:dark:shadow-purple-500/20 transition-shadow duration-200 p-6 text-center">
            ...
            <div className="text-4xl font-bold text-foreground mb-2" data-testid="total-dogs-stat">
          ...
          <div className="bg-card rounded-lg shadow-sm hover:shadow-md dark:shadow-purple-500/10 hover:dark:shadow-purple-500/20 transition-shadow duration-200 p-6 text-center">
            ...
            <div className="text-4xl font-bold text-foreground mb-2" data-testid="countries-stat">

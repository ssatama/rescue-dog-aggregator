...
describe('OrganizationSection', () => {
  ...
  describe('Organization Information Display', () => {
    test('displays organization name correctly', () => {
      ...
      expect(nameElement).toHaveClass('text-2xl', 'font-semibold', 'text-gray-900');
    });
  ...
  describe('Action Links', () => {
    test('renders "View all dogs" link with correct href', () => {
      ...
      expect(viewAllDogsLink).toHaveAttribute('href', '/dogs?organization_id=1');
      expect(viewAllDogsLink).toHaveTextContent('View all dogs from this rescue');
    });
    ...
    test('does not render "View all dogs" link when organizationId is missing and organization has no id', () => {
      ...
      expect(screen.queryByTestId('view-all-dogs-link')).not.toBeInTheDocument();
    });
    ...
    test('does not render "Visit Website" button when website_url is missing', () => {
      ...
      expect(screen.queryByTestId('visit-website-button')).not.toBeInTheDocument();
    });
  });
  ...
  describe('Styling and Classes', () => {
    test('applies correct CSS classes to main container', () => {
      ...
      expect(container).toHaveClass('border', 'rounded-lg', 'p-6', 'bg-gray-50');
    });
  ...
  describe('Accessibility', () => {
    test('all SVG icons have aria-hidden attribute', () => {
      ...
      const allSvgs = screen.getByTestId('organization-section').querySelectorAll('svg');
      allSvgs.forEach(svg => {

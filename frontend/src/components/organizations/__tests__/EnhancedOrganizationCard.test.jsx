...
describe('EnhancedOrganizationCard', () => {
  ...
  describe('1. Organization Logo (64px with fallback to initials)', () => {
    ...
    test('generates correct initials for single word', () => {
      const singleWordOrg = { ...mockOrganization, name: 'REAN', logo_url: null };
  ...
  describe('3. Dog Count with "NEW this week" Badge', () => {
    ...
    test('displays "NEW" badge when new_this_week > 0', () => {
      ...
      expect(screen.getByText('3 NEW')).toHaveClass('bg-green-100', 'text-green-800');
    });
  ...
  describe('4. Preview of 3 Most Recent Dog Thumbnails', () => {
    test('renders recent dog thumbnails when available', () => {
      ...
      expect(dogThumbnails[0]).toHaveAttribute('src', 'https://example.com/dog1.jpg');
      expect(dogThumbnails[1]).toHaveAttribute('src', 'https://example.com/dog2.jpg');
      expect(dogThumbnails[2]).toHaveAttribute('src', 'https://example.com/dog3.jpg');
    });
    ...
    test('handles case with exactly 3 dogs', () => {
      ...
      expect(screen.queryByText('and 0 more looking for homes')).not.toBeInTheDocument();
    });
  ...
  describe('Error Handling and Edge Cases', () => {
    ...
    test('handles very long organization names', () => {
      ...
      const nameElement = screen.getByText('Very Long Organization Name That Should Be Truncated Properly');

        ...
        <CardHeader className={styles.padding}>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-grow min-w-0">
              ...
              {city && country && (
                <p
                  className={`${styles.location} text-muted-foreground`}
                  data-testid="org-location"
                >
                  {city}, {country}
                </p>
              )}
        ...
        <CardContent className={`${styles.contentPadding} ${styles.spacing}`}>
          ...
          <div className={`space-y-2 ${styles.locationInfo}`}>
            ...
            {country && (
              <div
                ...
                data-testid="organization-location"
              >
          ...
          <div className="flex items-center justify-between pt-2">
            <div className="flex items-center space-x-2">
              <span
                className={`${styles.dogCount} font-bold text-foreground`}
                data-testid="org-dog-count"
              >
                {totalDogs}
              </span>
            ...
            <div className="pt-2">
              ...
              <p className="text-xs text-muted-foreground">
                {recentDogs
                  ...
                  .join(", ")}
                {totalDogs > 3 &&
                  ` and ${totalDogs - 3} more looking for homes`}
              </p>
            </div>
          )}
  ...
  (prevProps, nextProps) => {
    ...
    return (
      ...
      prevProps.organization?.total_dogs ===
        nextProps.organization?.total_dogs &&
      prevProps.organization?.new_this_week ===
        nextProps.organization?.new_this_week
    );
  },
);

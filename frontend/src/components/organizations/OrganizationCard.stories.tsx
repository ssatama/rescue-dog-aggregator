...
const mockOrganization = {
  ...
  description:
    "Animal Rescue Bosnia is a project of the EMKA Group for the rescue and placement of stray dogs without a home in new and loving hands in Europe.",
  logo_url:
    "https://images.rescuedogs.me/rescue_dogs/organizations/org-logo-animalrescuebosnia.png",
  active: true,
  total_dogs: 45,
  new_this_week: 3,
  ...
  recent_dogs: [
    {
      ...
      primary_image_url:
        "https://images.rescuedogs.me/rescue_dogs/animals/ksenon-2.jpg",
    },
    {
      id: 2,
      name: "Mirta",
...
export const LargeInternationalOrganization: Story = {
  args: {
    organization: {
      ...
      description:
        "We are a group of animal and nature loving people living in Switzerland with close ties to Turkey. Our mission is to help all breeds of cats and dogs in Turkey.",
      logo_url:
      ...
      recent_dogs: [
        {
          ...
          primary_image_url:
            "https://images.rescuedogs.me/rescue_dogs/animals/ayla-turkey.jpg",
        },
        {
          id: 5,
          name: "Murat",
          ...
          primary_image_url:
            "https://images.unsplash.com/photo-1520175480921-4edfa2983e0f?w=400&h=300&fit=crop",
        },
        {
          id: 6,
          name: "Zeynep",
...
export const GermanRescue: Story = {
  args: {
    organization: {
      ...
      description:
        "Daisy Family Rescue e.V. is a registered animal welfare organization in Germany dedicated to rescuing and rehoming dogs in need.",
      logo_url:
        "https://images.rescuedogs.me/rescue_dogs/organizations/org-logo-daisy-family.png",
      active: true,
      total_dogs: 28,
      new_this_week: 2,
      ...
      recent_dogs: [
        {
          ...
          primary_image_url:
            "https://images.rescuedogs.me/rescue_dogs/animals/tina-small.jpg",
        },
        {
          id: 8,
          name: "Bruno",

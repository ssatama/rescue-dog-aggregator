...
interface BreedDetailSkeletonProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string;
}
...
export default function BreedDetailSkeleton({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="sr-only">Loading breed details, please wait...</span>

...
describe('LoadingSkeleton', () => {
  describe('DogCardSkeleton', () => {
    ...
    test('should match real DogCard structure', () => {
      ...
      expect(screen.getByTestId('skeleton-description')).toHaveClass('h-4', 'w-1/2');
      
      // Button skeleton
      expect(screen.getByTestId('skeleton-button')).toHaveClass('h-10', 'w-full');
    });
  ...
  describe('TrustStatsSkeleton', () => {
    ...
    test('should have proper icon placeholder dimensions', () => {
      ...
      statBlocks.forEach(block => {
        const iconPlaceholder = block.querySelector('[data-testid="stat-icon-skeleton"]');

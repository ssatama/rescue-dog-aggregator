...
import HeroImageWithBlurredBackground, { HeroImageWithBlurredBackgroundProps } from '../HeroImageWithBlurredBackground';
...
describe('HeroImageWithBlurredBackground TypeScript Tests', () => {
  ...
  test('accepts required props with proper types', () => {
    ...
    expect(screen.getByTestId('hero-image')).toHaveAttribute('alt', 'Test image');
  });

  test('accepts optional className prop', () => {
    const className = 'custom-hero-class';
    
    render(<HeroImageWithBlurredBackground {...defaultProps} className={className} />);
  ...
  test('accepts optional onError callback', () => {
    ...
    render(<HeroImageWithBlurredBackground {...defaultProps} onError={onError} />);
  ...
  test('accepts optional useGradientFallback prop', () => {
    ...
    render(<HeroImageWithBlurredBackground {...defaultProps} useGradientFallback={useGradientFallback} />);
  ...
  test('component has proper displayName', () => {
    expect(HeroImageWithBlurredBackground.displayName).toBe('HeroImageWithBlurredBackground');
  });

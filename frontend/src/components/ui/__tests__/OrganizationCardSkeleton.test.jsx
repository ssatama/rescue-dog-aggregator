...
describe('OrganizationCardSkeleton', () => {
  ...
  describe('Recent Dogs Preview', () => {
    it('renders three dog thumbnail skeletons', () => {
      ...
      const thumbnailSkeletons = screen.getAllByTestId('skeleton-dog-thumbnail');
  ...
  describe('Social Media Section', () => {
    it('renders social media icon skeletons', () => {
      ...
      const socialMediaSkeletons = screen.getAllByTestId('skeleton-social-icon');
  ...
  describe('Footer Section', () => {
    it('renders two CTA button skeletons', () => {
      ...
      const websiteButtonSkeleton = screen.getByTestId('skeleton-website-button');
      expect(websiteButtonSkeleton).toBeInTheDocument();
      expect(websiteButtonSkeleton).toHaveClass('h-8', 'flex-1');
      
      const viewDogsButtonSkeleton = screen.getByTestId('skeleton-view-dogs-button');
    ...
    it('has proper button spacing', () => {
      ...
      const buttonContainerSkeleton = screen.getByTestId('skeleton-button-container');
      expect(buttonContainerSkeleton).toHaveClass('flex', 'space-x-3', 'w-full');
    });
  });
  ...
  describe('Accessibility', () => {
    it('has proper ARIA attributes', () => {
      ...
      const skeleton = screen.getByTestId('organization-card-skeleton');
      expect(skeleton).toHaveAttribute('aria-label', 'Loading organization information');

...
describe('OrganizationLink', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    test('should handle organization names with spaces and special characters', () => {
      ...
      const link = screen.getByRole('link');
      expect(link).toHaveAttribute('href', '/dogs?organization=berlin-rescue-shelter');
    });
  });
  ...
  describe('Accessibility', () => {
    test('should have proper accessibility attributes', () => {
      ...
      const link = screen.getByRole('link');
      expect(link).toHaveAttribute('aria-label', 'View 45 dogs from Pets in Turkey');
    });
  ...
  describe('Edge Cases', () => {
    ...
    test('should handle single dog count', () => {
      ...
      const link = screen.getByRole('link');
      expect(link).toHaveAttribute('aria-label', 'View 1 dogs from Small Rescue');
    });
    ...
    test('should handle very long organization names', () => {
      ...
      expect(screen.getByText('Very Long Organization Name That Might Cause Layout Issues (15)')).toBeInTheDocument();
    });
  });

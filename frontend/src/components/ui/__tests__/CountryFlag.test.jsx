...
describe('CountryFlag', () => {
  ...
  test('renders with medium size when specified', () => {
    render(<CountryFlag countryCode="DE" countryName="Germany" size="medium" />);
  ...
  test('applies custom className when provided', () => {
    render(<CountryFlag countryCode="IT" countryName="Italy" className="custom-class" />);
  ...
  test('converts country code to lowercase for flag URL', () => {
    ...
    const flagImage = screen.getByRole('img');
    expect(flagImage).toHaveAttribute('src', expect.stringContaining('gb.png'));
    expect(flagImage).toHaveAttribute('src', expect.not.stringContaining('GB.png'));
  });

...
function SocialIcon({ platform, className = "h-5 w-5 text-gray-600 dark:text-gray-400" }: SocialIconProps): React.JSX.Element {
 ...
 */
export default function SocialMediaLinks({ socialMedia, className = "" }: SocialMediaLinksProps): React.JSX.Element | null {

...
export interface ToastContextType {
  showToast: (message: string, type?: ToastType, duration?: number) => NodeJS.Timeout;
  hideToast: () => void;
}
...
export function ToastProvider({ children }: ToastProviderProps) {
  ...
  const showToast = useCallback((message: string, type: ToastType = 'info', duration: number = 3000): NodeJS.Timeout => {

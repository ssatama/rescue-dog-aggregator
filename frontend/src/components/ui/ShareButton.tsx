  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant={variant} size={size} className={className} data-testid="share-button" data-share-mode="dropdown">
          <Icon name="share" size="small" className="mr-2" />
          Share
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent align="end" className="w-48" data-testid="social-media-links">
        <DropdownMenuItem onClick={() => handleSocialShare('facebook')} data-testid="share-facebook">
          Share on Facebook
        </DropdownMenuItem>
        <DropdownMenuItem onClick={() => handleSocialShare('x')} data-testid="share-twitter">
          Share on X
        </DropdownMenuItem>
        <DropdownMenuItem onClick={() => handleSocialShare('whatsapp')} data-testid="share-whatsapp">
          Share on WhatsApp
        </DropdownMenuItem>

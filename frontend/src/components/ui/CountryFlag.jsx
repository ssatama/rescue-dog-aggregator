 ...
 * 
 * @param {string} countryCode - ISO 2-letter country code (e.g., 'TR', 'DE')
 * @param {string} countryName - Full country name for alt text
 * @param {string} size - Flag size: 'small' (default), 'medium', or 'large'

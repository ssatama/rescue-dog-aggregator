...
const mockDog = {
  ...
  dog_profiler_data: {
    description: 'Buddy is a lovable 2-year-old Golden Mix seeking his forever home. This playful pup has a heart of gold and endless energy for adventures.',
...
describe('SwipeDetails', () => {
  ...
  it('should show full personality description', () => {
    ...
    expect(screen.getByText(/Buddy is a lovable 2-year-old Golden Mix/)).toBeInTheDocument();
  ...
  it('should include adoption CTA button', () => {
    ...
    const adoptButton = screen.getByRole('button', { name: /Start Adoption Process/i });

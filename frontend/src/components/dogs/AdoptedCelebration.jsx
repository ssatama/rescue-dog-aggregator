      ...
      <div className="relative z-10 text-center">
        ...
        <div className="mb-6">
          <h2 className="text-2xl md:text-3xl font-semibold text-white mb-2">
            {dogName ? `${dogName} has found their forever home!` : 'This wonderful dog has been adopted!'} 🏡
          </h2>
        ...
        <div className="text-sm text-purple-200 bg-purple-800/30 rounded-lg p-3 backdrop-blur-sm">
          <p>
            We keep this page active to celebrate our success stories and inspire more adoptions. 
            Every rescue dog finding their forever home is worth celebrating! 🐾
          </p>
        </div>

...
export default function ActivitiesQuirksExample() {
  const exampleData: DogProfilerData = {
    ...
    unique_quirk:
      "Loves to carry his favorite squeaky toy everywhere and won't eat dinner without it nearby!",
    confidence_scores: {
  ...
  const quirkOnlyData: DogProfilerData = {
    favorite_activities: [],
    unique_quirk:
      "Has learned to open doors and will escape to find the mailman every day at 3 PM",
    confidence_scores: {
    ...
    <div className="max-w-2xl mx-auto p-6 space-y-8">
        ...
        <section>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border min-h-[100px] flex items-center justify-center text-gray-500">
            ...
            <span className="italic">
              Component returns null when confidence scores are too low
            </span>
          </div>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-gray-800 mb-4">No Data</h2>
          <div className="bg-white p-6 rounded-lg shadow-sm border min-h-[100px] flex items-center justify-center text-gray-500">
      ...
      <div className="bg-blue-50 p-6 rounded-lg">
        ...
        <ul className="text-blue-800 space-y-2 text-sm">
          <li>
            • Only shows activities when confidence_scores.favorite_activities
            &gt; 0.5
          </li>
          <li>
            • Only shows quirk when confidence_scores.unique_quirk &gt; 0.5
          </li>
          <li>
            • Activities display with relevant emojis (🏃 running, 🏊 swimming,
            🎾 playing, etc.)
          </li>
          <li>
            • Component returns null if no sections meet confidence requirements
          </li>
          <li>
            • Colors rotate through engaging Tailwind palette for activities
          </li>

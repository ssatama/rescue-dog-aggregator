import { getAnimals, getAnimalById, getAnimalsByStandardizedBreed, getRandomAnimals } from '../animalsService';
...
describe('animalsService meta endpoints', () => {
  ...
  it('getAvailableRegions returns [] and skips fetch when no country selected', async () => {
    ...
    expect(get).not.toHaveBeenCalledWith('/api/animals/meta/available_regions', expect.anything());
  });
  ...
  it('getAvailableRegions calls endpoint when country provided', async () => {
    ...
    expect(get).toHaveBeenCalledWith('/api/animals/meta/available_regions', { country: 'Canada' });
  ...
  it('getStandardizedBreeds calls GET /api/animals/meta/breeds with breed_group', async () => {
    ...
    expect(get).toHaveBeenCalledWith('/api/animals/meta/breeds', { breed_group: 'Sporting' });

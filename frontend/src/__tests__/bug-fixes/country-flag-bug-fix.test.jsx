...
describe('Country Flag Bug Fix', () => {
  describe('UK/GB Country Code Handling', () => {
    ...
    test('CountryFlag renders properly for UK country code', () => {
      render(<CountryFlag countryCode="UK" countryName="United Kingdom" size="small" />);
    ...
    test('CountryFlag renders properly for GB country code', () => {
      render(<CountryFlag countryCode="GB" countryName="United Kingdom" size="small" />);
  ...
  describe('Flag Display Integration', () => {
    test('shows proper flag URL for UK country code', () => {
      ...
      expect(flagImage).toHaveAttribute('src', 'https://flagcdn.com/20x15/gb.png');
    });

    test('displays placeholder correctly for invalid codes', () => {
      render(<CountryFlag countryCode="INVALID" countryName="Invalid Country" size="small" />);
  ...
  describe('Regression Prevention', () => {
    ...
    test('all flag sizes work with UK alias', () => {
      ...
      sizes.forEach(size => {
        const { unmount } = render(
          <CountryFlag countryCode="UK" countryName="United Kingdom" size={size} />
        );

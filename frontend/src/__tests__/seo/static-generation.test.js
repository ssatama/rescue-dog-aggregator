...
describe('SEO Static Generation Validation', () => {
  ...
  describe('generateStaticParams Integration', () => {
    test('both dog and organization static params work together', async () => {
      ...
      const { generateStaticParams: generateDogParams } = await import('../../app/dogs/[slug]/page');
      const { generateStaticParams: generateOrgParams } = await import('../../app/organizations/[slug]/page');
  ...
  describe('Error Resilience', () => {
    test('continues to work if one service fails', async () => {
      ...
      getAllOrganizations.mockRejectedValue(new Error('Database connection failed'));

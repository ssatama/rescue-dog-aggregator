...
function TestUtilityComponent({ className }) {
  return (
    <div className={className} data-testid="utility-element">
      Test Content
    </div>
  );
}
...
describe("Globals.css Utility Classes - Dark Mode Support", () => {
  ...
  describe("Shimmer Animations", () => {
    test("animate-shimmer-warm should render in dark mode", () => {
      renderWithDarkTheme(
        <TestUtilityComponent className="animate-shimmer-warm" />,
      );
    ...
    test("animate-shimmer-premium should render in dark mode", () => {
      renderWithDarkTheme(
        <TestUtilityComponent className="animate-shimmer-premium" />,
      );
  ...
  describe("Interactive Utilities", () => {
    ...
    test("animate-card-hover should render in dark mode", () => {
      renderWithDarkTheme(
        <TestUtilityComponent className="animate-card-hover" />,
      );
    ...
    test("animate-button-hover should render in dark mode", () => {
      renderWithDarkTheme(
        <TestUtilityComponent className="animate-button-hover" />,
      );
  ...
  describe("Animation Utilities", () => {
    ...
    test("animate-fade-in-up should render in dark mode", () => {
      renderWithDarkTheme(
        <TestUtilityComponent className="animate-fade-in-up" />,
      );
    ...
    test("animate-page-enter should render in dark mode", () => {
      renderWithDarkTheme(
        <TestUtilityComponent className="animate-page-enter" />,
      );
  ...
  describe("Theme Consistent Utilities", () => {
    test("theme-consistent-card should render in dark mode", () => {
      renderWithDarkTheme(
        <TestUtilityComponent className="theme-consistent-card" />,
      );
    ...
    test("theme-consistent-button should render in dark mode", () => {
      renderWithDarkTheme(
        <TestUtilityComponent className="theme-consistent-button" />,
      );
    ...
    test("theme-consistent-input should render in dark mode", () => {
      renderWithDarkTheme(
        <TestUtilityComponent className="theme-consistent-input" />,
      );

...
describe('About Page Dark Mode', () => {
  ...
  test('page header has dark mode text colors', () => {
    ...
    // Subtitle
    const subtitle = screen.getByText('Connecting loving homes with rescue dogs in need.');
  ...
  test('step descriptions have dark mode colors', () => {
    ...
    const browseDescription = screen.getByText(/Use our search and filter tools/);
    ...
    [browseDescription, detailsDescription, connectDescription].forEach(desc => {

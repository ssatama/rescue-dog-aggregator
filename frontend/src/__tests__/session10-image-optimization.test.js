...
describe('Session 10: Image Optimization Verification', () => {
  describe('LazyImage Component Enhancements', () => {
    test('LazyImage supports sizes attribute for responsive images', () => {
      const testSizes = "(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw";
    ...
    test('LazyImage maintains WebP support via Cloudinary f_auto', () => {
      const cloudinaryUrl = "https://res.cloudinary.com/test/image/upload/v123/test.jpg";
    ...
    test('LazyImage handles error states with proper fallback', () => {
      ...
      const containers = screen.getAllByRole('img', { name: /Error test image/i });
  ...
  describe('DogCard Image Optimization', () => {
    const mockDog = {
      ...
      name: "Test Dog",
      breed: "Test Breed",
      primary_image_url: "https://res.cloudinary.com/test/image/upload/v123/dog.jpg",
      age_min_months: 24,
      gender: "Male",
    ...
    test('DogCard uses LazyImage with proper responsive sizes', () => {
      ...
      const dogImage = imageElements.find(img => img.getAttribute('aria-label') === 'Test Dog' || img.getAttribute('alt') === 'Test Dog');
  ...
  describe('OrganizationCard Image Optimization', () => {
      ...
      recent_dogs: [
        {
          id: 1,
          name: "Dog 1",
          thumbnail_url: "https://res.cloudinary.com/test/image/upload/v123/thumb1.jpg"
        },
        {
          id: 2,
          name: "Dog 2",
          thumbnail_url: "https://res.cloudinary.com/test/image/upload/v123/thumb2.jpg"
        }
      ]
    };
    ...
    test('OrganizationCard dog thumbnails use small responsive sizes', () => {
      ...
      const thumbnailContainers = document.querySelectorAll('[class*="rounded-lg"]');
  ...
  describe('RelatedDogsCard Image Optimization', () => {
    const mockDog = {
      ...
      name: "Related Dog",
      breed: "Test Breed",
      primary_image_url: "https://res.cloudinary.com/test/image/upload/v123/related.jpg",
      age_min_months: 18,
      organization: { name: "Test Org" }
    };
  ...
  describe('WebP Format and Cloudinary Integration', () => {
    test('Cloudinary URLs maintain f_auto parameter for WebP support', () => {
      const cloudinaryUrl = "https://res.cloudinary.com/test/image/upload/w_400,h_300,c_fill,g_auto,f_auto,q_auto/test.jpg";
    ...
    test('Image optimization maintains quality settings', () => {
      const optimizedUrl = "https://res.cloudinary.com/test/image/upload/w_800,h_600,c_fill,g_auto,f_auto,q_auto/high-quality.jpg";
  ...
  describe('Performance and Loading Behavior', () => {
    ...
    test('Images have proper alt text for accessibility', () => {
      ...
      const imageElements = screen.getAllByRole('img', { name: /Accessibility Test Dog/i });
      expect(imageElements.length).toBeGreaterThan(0);
      
      // Check that elements have proper accessibility attributes
      imageElements.forEach(element => {
        const hasAltOrAriaLabel = element.getAttribute('alt') === 'Accessibility Test Dog' || 
  ...
  describe('Responsive Breakpoint Verification', () => {
    test('Different components use appropriate sizes for their use case', () => {
      const mockDog = { id: 1, name: "Size Test", primary_image_url: "https://example.com/test.jpg" };
      const mockOrg = { id: 1, name: "Test Org", logo_url: "https://example.com/logo.jpg", total_dogs: 1 };

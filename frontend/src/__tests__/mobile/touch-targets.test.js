...
describe('Mobile Touch Targets Validation', () => {
  ...
  beforeEach(() => {
    // Mock API responses
    require('../../services/animalsService').getAnimalsByCuration.mockResolvedValue([mockDog]);
    require('../../services/animalsService').getStatistics.mockResolvedValue(mockStats);

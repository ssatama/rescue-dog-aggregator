...
describe('Organizations Grid Accessibility', () => {
  ...
  test('maintains proper tab order', async () => {
    ...
    const focusableElements = screen.getAllByRole('button', { name: /View \d+ dogs from/i });
  ...
  test('provides screen reader friendly content', async () => {
    ...
    const orgNames = [
      'REAN', 'Pets in Turkey', 'Tierschutzverein Europa e.V.',
      'German Shepherd Rescue', 'French Bulldog Rescue', 
      'Golden Retriever Rescue', 'Mixed Breed Rescue'
    ];

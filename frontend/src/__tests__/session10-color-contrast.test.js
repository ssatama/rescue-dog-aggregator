...
const TestText = ({ background, textColor, children, size = "normal" }) => (
  <div
    className={`bg-${background} text-${textColor} ${size === "large" ? "text-xl" : "text-base"}`}
  >
    {children}
  </div>
);
    ...
    test("Primary text colors should meet WCAG AA standards", () => {
      const textContrasts = [
        ...
        },
        {
          bg: "white",
          text: "gray-700",
          description: "Secondary text on white background",
        },
        {
          bg: "white",
          text: "gray-600",
          description: "Muted text on white background",
        },
        {
          bg: "gray-50",
          text: "gray-900",
          description: "Primary text on light gray background",
        },
      ];
    ...
    test("Link colors should meet WCAG AA standards", () => {
      const linkContrasts = [
        { bg: "white", text: "orange-600", description: "Primary link color" },
        {
          bg: "white",
          text: "blue-600",
          description: "Alternative link color",
        },
      ];
      ...
      const largeTextContrasts = [
        {
          bg: "white",
          text: "gray-700",
          description: "Large heading on white",
        },
        {
          bg: "orange-50",
          text: "orange-600",
          description: "Large text on orange background",
        },
      ];
      ...
      const focusContrasts = [
        {
          bg: "white",
          focus: "orange-600",
          description: "Orange focus ring on white background",
        },
        {
          bg: "gray-50",
          focus: "orange-600",
          description: "Orange focus ring on light gray",
        },
        {
          bg: "orange-100",
          focus: "orange-800",
          description: "Much darker orange focus on orange background",
        },
      ];
    ...
    test("Active states should maintain adequate contrast", () => {
      const activeContrasts = [
        ...
        },
        {
          bg: "orange-600",
          text: "white",
          description: "Active primary button",
        },
      ];
    ...
    test("Filter component colors should meet contrast requirements", () => {
      const filterContrasts = [
        ...
        { bg: "white", text: "gray-700", description: "Inactive filter state" },
        {
          bg: "orange-50",
          text: "orange-600",
          description: "Filter hover state",
        },
      ];
    ...
    test("Generate comprehensive contrast report", () => {
      const allColorCombinations = [
        // Primary text
        {
          ...
          text: "gray-900",
          expected: 21,
          actual: getContrastRatio("white", "gray-900"),
        },
        {
          bg: "white",
          text: "gray-700",
          expected: 10.7,
          actual: getContrastRatio("white", "gray-700"),
        },
        {
          bg: "white",
          text: "gray-600",
          expected: 7.23,
          actual: getContrastRatio("white", "gray-600"),
        },
        ...
        // Button colors
        {
          ...
          text: "white",
          expected: 4.53,
          actual: getContrastRatio("orange-600", "white"),
        },
        {
          bg: "orange-500",
          text: "white",
          expected: 3.14,
          actual: getContrastRatio("orange-500", "white"),
        },
        ...
        // Active states
        {
          ...
          text: "orange-700",
          expected: 4.8,
          actual: getContrastRatio("orange-100", "orange-700"),
        },
        {
          bg: "orange-50",
          text: "orange-700",
          expected: 5.2,
          actual: getContrastRatio("orange-50", "orange-700"),
        },
      ];

      // Generate report
      const passedCombinations = allColorCombinations.filter(
        (combo) => combo.actual >= 4.5,
      );
      const warningCombinations = allColorCombinations.filter(
        (combo) => combo.actual >= 3.0 && combo.actual < 4.5,
      );
      const failedCombinations = allColorCombinations.filter(
        (combo) => combo.actual < 3.0,
      );
      ...
      expect(passedCombinations.length).toBeGreaterThan(
        warningCombinations.length,
      );
    });
  });
});

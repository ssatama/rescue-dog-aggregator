...
export const useReducedMotion = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (process.env.NODE_ENV !== 'production') console.warn('matchMedia not supported, animations will be enabled');
    }
  }, []);
...
export const ScrollAnimationWrapper = ({ 
  ...
  const [ref, isVisible] = useScrollAnimation({ threshold, rootMargin, triggerOnce, delay });

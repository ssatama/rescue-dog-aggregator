    ...
    def _rollback_scrape_session(self, organization_id: int, session_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            cursor.execute("""
                ...
                AND last_scraped_at >= %s
                AND created_at < %s
            """, (session_time - timedelta(hours=1), organization_id, session_time, session_time))
...
class DataRecoveryManager:
    ...
    def _validate_consistency(self, organization_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            consistent = (
                total_animals > 0 and
                uniqueness_ratio >= 0.98 and  # 98% unique external_ids
...
class EmergencyOperationsCommands:
    ...
    def create_backup(self, organization_id: int, reason: str = "Manual backup") -> Dict[str, Any]:
        ...
        return self.emergency_ops.rollback_manager.create_data_backup(organization_id, reason)

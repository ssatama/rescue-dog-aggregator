...
class QualifyingBreed(BaseModel):
    ...
    purebred_count: int = Field(default=0, description="How many of the count are purebred", ge=0)
    crossbreed_count: int = Field(default=0, description="How many of the count are crosses of this breed", ge=0)

...
class TestCloudinaryService:
    ...
    @patch.dict(os.environ, {"CLOUDINARY_CLOUD_NAME": "test_cloud", "CLOUDINARY_API_KEY": "test_key", "CLOUDINARY_API_SECRET": "test_secret"})
    ...
    def test_check_configuration_success(self, mock_config):
        ...
        mock_config.assert_called_once_with(cloud_name="test_cloud", api_key="test_key", api_secret="test_secret", secure=True)
    ...
    @patch.dict(os.environ, {"CLOUDINARY_CLOUD_NAME": "test_cloud", "CLOUDINARY_API_KEY": "", "CLOUDINARY_API_SECRET": "test_secret"})  # Missing key
    ...
    def test_check_configuration_caching(self):
        ...
        with patch.dict(os.environ, {"CLOUDINARY_CLOUD_NAME": "test_cloud", "CLOUDINARY_API_KEY": "test_key", "CLOUDINARY_API_SECRET": "test_secret"}):
    ...
    def test_upload_image_from_url_no_url(self):
        ...
        result_url, success = CloudinaryService.upload_image_from_url(None, "test_animal")
    ...
    def test_upload_image_from_url_empty_url(self):
        ...
        result_url, success = CloudinaryService.upload_image_from_url("", "test_animal")

        assert result_url is None
        assert success is False

    @patch.object(CloudinaryService, "_check_configuration", return_value=False)
    def test_upload_image_from_url_not_configured_with_raise(self, mock_check):
        ...
        with pytest.raises(CloudinaryConfigurationError):
            CloudinaryService.upload_image_from_url("https://example.com/image.jpg", "test_animal", raise_on_missing_config=True)
    ...
    def test_upload_image_from_url_not_configured_fallback(self, mock_check):
        ...
        result_url, success = CloudinaryService.upload_image_from_url(original_url, "test_animal")
    ...
    def test_upload_image_from_url_existing_image(self, mock_resource, mock_check):
        """Test handling of image that already exists in Cloudinary."""
        mock_resource.return_value = {"secure_url": "https://res.cloudinary.com/test/existing.jpg"}

        result_url, success = CloudinaryService.upload_image_from_url("https://example.com/image.jpg", "test_animal", "test_org")
    ...
    def test_upload_image_from_url_successful_upload(self, mock_upload, mock_get, mock_resource, mock_check):
        ...
        mock_upload.return_value = {"secure_url": "https://res.cloudinary.com/test/uploaded.jpg"}

        result_url, success = CloudinaryService.upload_image_from_url("https://example.com/image.jpg", "test animal", "test org")
    ...
    @patch("utils.cloudinary_service.cloudinary.api.resource")
    @patch("utils.cloudinary_service.requests.get")
    def test_upload_image_from_url_download_failure(self, mock_get, mock_resource, mock_check):
    ...
    @patch("utils.cloudinary_service.cloudinary.api.resource")
    @patch("utils.cloudinary_service.requests.get")
    def test_upload_image_from_url_invalid_status_code(self, mock_get, mock_resource, mock_check):
    ...
    @patch("utils.cloudinary_service.cloudinary.api.resource")
    @patch("utils.cloudinary_service.requests.get")
    def test_upload_image_from_url_invalid_content_type(self, mock_get, mock_resource, mock_check):
    ...
    @patch("utils.cloudinary_service.requests.get")
    @patch("utils.cloudinary_service.cloudinary.uploader.upload")
    def test_upload_image_from_url_cloudinary_error(self, mock_upload, mock_get, mock_resource, mock_check):
    ...
    @patch("utils.cloudinary_service.requests.get")
    @patch("utils.cloudinary_service.cloudinary.uploader.upload")
    def test_upload_image_from_url_unexpected_error(self, mock_upload, mock_get, mock_resource, mock_check):
    ...
    def test_get_optimized_url_with_transformations(self, mock_cloudinary_image, mock_is_configured):
        ...
        result = CloudinaryService.get_optimized_url(cloudinary_url, transformations)
    ...
    @patch.object(CloudinaryService, "is_configured", return_value=True)
    @patch("utils.cloudinary_service.cloudinary.CloudinaryImage")
    def test_get_optimized_url_error_handling(self, mock_cloudinary_image, mock_is_configured):
        """Test error handling in URL optimization."""
        mock_cloudinary_image.side_effect = Exception("Transformation error")

        cloudinary_url = "https://res.cloudinary.com/test/upload/v123/image.jpg"
        result = CloudinaryService.get_optimized_url(cloudinary_url, {"width": 300})
    ...
    @patch("utils.cloudinary_service.cloudinary.api.resource")
    @patch("utils.cloudinary_service.requests.get")
    def test_upload_image_requests_timeout(self, mock_get, mock_resource, mock_check):
    ...
    @patch("utils.cloudinary_service.cloudinary.api.resource")
    @patch("utils.cloudinary_service.requests.get")
    def test_upload_image_user_agent_header(self, mock_get, mock_resource, mock_check):
        ...
        CloudinaryService.upload_image_from_url("https://example.com/image.jpg", "test_animal")
    ...
    def test_upload_public_id_generation(self, mock_resource, mock_check):
        ...
        with patch("utils.cloudinary_service.requests.get") as mock_get:
            ...
            CloudinaryService.upload_image_from_url("https://example.com/image.jpg", "Test Animal Name", "Test Organization")

            # Check that public_id was generated correctly
            mock_resource.assert_called_once()
            public_id = mock_resource.call_args[0][0]

            assert public_id.startswith("rescue_dogs/test_organization/test_animal_name_")

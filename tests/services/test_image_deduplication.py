...
class TestImageDeduplication:
    ...
    def mock_r2_service(self):
        ...
        mock_r2 = Mock()
        mock_r2.batch_upload_images_with_stats.return_value = (
            [("https://images.rescuedogs.me/org/dog1.jpg", True)],
            {"successful": 1, "total": 1, "success_rate": 100.0, "total_time": 1.0},
        )
        mock_r2.concurrent_upload_images_with_stats.return_value = (
            [("https://images.rescuedogs.me/org/dog1.jpg", True)],
            {"successful": 1, "total": 1, "success_rate": 100.0, "total_time": 1.0},
        )
        return mock_r2
    ...
    def test_deduplication_skips_invalid_urls(
        ...
        animals_data = [
            {
                "name": "Dog1",
                "primary_image_url": "data:image/png;base64,abc123",
            },  # Data URL
            {
                "name": "Dog2",
                "primary_image_url": "https://images.rescuedogs.me/existing.jpg",
            },  # Already R2
            {
                "name": "Dog3",
                "primary_image_url": "https://example.com/valid.jpg",
            },  # Valid
        ]

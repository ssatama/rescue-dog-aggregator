...
class TestAdoptionDetectionService:
    ...
    def test_check_adoption_status_adopted(self, service, mock_animal, mock_firecrawl):
        ...
        mock_firecrawl.extract = Mock(return_value={"data": [{"status": "adopted", "evidence": "This dog has been ADOPTED and found their forever home!", "confidence": 0.95}]})
    ...
    def test_check_adoption_status_reserved(self, service, mock_animal, mock_firecrawl):
        ...
        mock_firecrawl.extract = Mock(return_value={"data": [{"status": "reserved", "evidence": "This dog is RESERVED pending adoption", "confidence": 0.85}]})
    ...
    def test_check_adoption_status_available(self, service, mock_animal, mock_firecrawl):
        ...
        mock_firecrawl.extract = Mock(return_value={"data": [{"status": "available", "evidence": "Buddy is still looking for a home", "confidence": 0.90}]})
    ...
    def test_extract_with_retry_success(self, service, mock_firecrawl):
        ...
        mock_firecrawl.extract = Mock(return_value={"data": [{"status": "adopted", "evidence": "Adopted!", "confidence": 0.9}]})
    ...
    def test_extract_with_retry_second_attempt(self, service, mock_firecrawl):
        ...
        mock_firecrawl.extract = Mock(side_effect=[Exception("Temporary error"), {"data": [{"status": "adopted", "evidence": "Adopted!", "confidence": 0.9}]}])
    ...
    def test_batch_check_adoptions(self, service, mock_firecrawl):
        ...
        results = service.batch_check_adoptions(mock_db, organization_id=1, threshold=3, limit=50, dry_run=False)
    ...
    def test_batch_check_adoptions_dry_run(self, service, mock_firecrawl):
        ...
        mock_firecrawl.extract = Mock(return_value={"data": [{"status": "adopted", "evidence": "Adopted!", "confidence": 0.95}]})
    ...
    def test_batch_check_handles_individual_errors(self, service, mock_firecrawl):
        ...
        results = service.batch_check_adoptions(mock_db, organization_id=1, dry_run=False)

...
class TestTerminalLoggingFix:
    ...
    def test_terminal_and_database_logging_consistency_after_fix(self):
        ...
        with (
            patch.object(scraper, "start_scrape_log", return_value=True),
            patch.object(scraper, "start_scrape_session", return_value=True),
            patch.object(
                scraper,
                "_process_animals_data",
                return_value={"animals_added": 0, "animals_updated": 0, "animals_unchanged": 0, "images_uploaded": 0, "images_failed": 0, "potential_failure_detected": False},
            ),
            ...
            assert terminal_count == database_count == 42, f"Terminal shows {terminal_count}, DB shows {database_count}, both should be 42"
    ...
    def test_terminal_logging_without_skip_existing_animals(self):
        ...
        with (
            ...
            patch.object(
                scraper,
                "_process_animals_data",
                return_value={"animals_added": 3, "animals_updated": 0, "animals_unchanged": 0, "images_uploaded": 0, "images_failed": 0, "potential_failure_detected": False},
            ),
            patch.object(scraper, "_finalize_scrape"),
            patch.object(scraper, "_log_completion_metrics"),
        ):
            ...
            assert terminal_count == database_count == 3, f"Terminal shows {terminal_count}, DB shows {database_count}, both should be 3"
    ...
    def test_partial_filtering_scenario(self):
        ...
        with (
            ...
            patch.object(
                scraper,
                "_process_animals_data",
                return_value={"animals_added": 2, "animals_updated": 0, "animals_unchanged": 0, "images_uploaded": 0, "images_failed": 0, "potential_failure_detected": False},
            ),
            patch.object(scraper, "_finalize_scrape"),
            patch.object(scraper, "_log_completion_metrics"),
        ):
            ...
            assert terminal_count == database_count == 5, f"Terminal shows {terminal_count}, DB shows {database_count}, both should be 5"
    ...
    def test_no_filtering_stats_fallback(self):
        ...
        with (
            ...
            assert terminal_count == database_count == 2, f"Terminal shows {terminal_count}, DB shows {database_count}, both should be 2"

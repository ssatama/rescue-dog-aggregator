...
class TestSanterPawsBulgarianRescueStandardization(unittest.TestCase):
    ...
    def test_extract_dog_name_from_url_formats(self):
        ...
        self.assertEqual(
            self.scraper._extract_dog_name_from_url("https://santerpawsbulgarianrescue.com/dog/summer-breeze/"),
            "Summer Breeze",
        )

        # Test single word names
        self.assertEqual(
            self.scraper._extract_dog_name_from_url("https://santerpawsbulgarianrescue.com/dog/pepper/"),
            "Pepper",
        )

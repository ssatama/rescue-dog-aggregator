...
class TestREANUnifiedExtraction:
    ...
    def test_unified_extraction_success_scenario(self, mock_sleep):
        ...
        with patch("selenium.webdriver.Chrome") as mock_chrome:
            ...
            mock_img1 = Mock()
            mock_img1.get_attribute.side_effect = lambda attr: {"src": "https://img1.wsimg.com/isteam/ip/abc/toby-correct.jpg", "data-src": None}.get(attr)
            ...
            mock_img2 = Mock()
            mock_img2.get_attribute.side_effect = lambda attr: {"src": "https://img1.wsimg.com/isteam/ip/abc/bobbie-correct.jpg", "data-src": None}.get(attr)
    ...
    def test_unified_extraction_container_detection_fallback(self, mock_sleep):
        ...
        with patch("selenium.webdriver.Chrome") as mock_chrome:
            ...
            mock_img = Mock()
            mock_img.get_attribute.side_effect = lambda attr: {"src": "https://img1.wsimg.com/isteam/ip/abc/toby.jpg", "data-src": None}.get(attr)
    ...
    def test_comprehensive_lazy_loading_trigger(self, mock_sleep):
        ...
        mock_driver = Mock()
        mock_driver.execute_script.side_effect = [1500, None, None, None, None, None, None]  # document.body.scrollHeight  # scroll commands
    ...
    def test_image_extraction_from_container(self):
        ...
        invalid_img = Mock()
        invalid_img.get_attribute.side_effect = lambda attr: {"src": "data:image/gif;base64,placeholder", "data-src": None}.get(attr)
        ...
        result = scraper._extract_image_from_container(mock_container, "Toby", 1)
    ...
    def test_single_dog_extraction_from_container(self):
        ...
        result = scraper._extract_single_dog_from_container(mock_container, "romania", 1)
    ...
    def test_unified_extraction_end_to_end_realistic(self, mock_sleep):
        ...
        with patch("selenium.webdriver.Chrome") as mock_chrome:
            ...
            bobbie_img = Mock()
            bobbie_img.get_attribute.side_effect = lambda attr: {"src": "https://img1.wsimg.com/isteam/ip/rean/bobbie-with-boot.jpg", "data-src": None}.get(attr)  # Boot image
            ...
            toby_img = Mock()
            toby_img.get_attribute.side_effect = lambda attr: {"src": "https://img1.wsimg.com/isteam/ip/rean/toby-brown-puppy.jpg", "data-src": None}.get(attr)  # Brown puppy image
            ...
            result = scraper.extract_dogs_with_images_unified("https://rean.org.uk/dogs-%26-puppies-in-romania", "romania")

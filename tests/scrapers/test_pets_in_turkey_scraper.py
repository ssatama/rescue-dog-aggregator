...
class TestPetsInTurkeyScraper:
    ...
    def test_setup_selenium_success(
            self, mock_service, mock_chrome, mock_driver_manager):
    ...
    def test_setup_selenium_failure(self, mock_driver_manager):
        ...
        with patch('scrapers.pets_in_turkey.dogs_scraper.BaseScraper.__init__'):
            ...
            mock_driver_manager.side_effect = Exception(
                "ChromeDriver not found")

            result = scraper._setup_selenium()

            assert result is None
            scraper.logger.error.assert_called_with(
                "Error setting up Selenium: ChromeDriver not found")
    ...
    def test_safe_driver_operation_success(self):
        ...
        with patch('scrapers.pets_in_turkey.dogs_scraper.BaseScraper.__init__'):
            ...
            result = scraper._safe_driver_operation(
                mock_operation, "arg1", key="value")
    ...
    def test_safe_driver_operation_failure(self):
        ...
        with patch('scrapers.pets_in_turkey.dogs_scraper.BaseScraper.__init__'):
            ...
            mock_operation = Mock(
                side_effect=WebDriverException("Operation failed"))
    ...
    def test_collect_data_selenium_setup_failure(self):
        ...
        with patch('scrapers.pets_in_turkey.dogs_scraper.BaseScraper.__init__'):
            ...
            assert result == []
            scraper.logger.error.assert_called_with(
                "Failed to set up Selenium WebDriver")
    ...
    def test_collect_data_driver_cleanup_on_error(self, mock_wait, mock_sleep):
        ...
        with patch('scrapers.pets_in_turkey.dogs_scraper.BaseScraper.__init__'):
            ...
            scraper.logger.warning.assert_called_with(
                "Error during WebDriver cleanup: Quit failed")
...
Unknown Weight"""
    ...
    def test_find_image_for_container_exception(self):
        ...
        with patch('scrapers.pets_in_turkey.dogs_scraper.BaseScraper.__init__'):
            ...
            mock_container = Mock()
            mock_container.find_elements.side_effect = Exception(
                "Element not found")
            ...
            assert result is None
            scraper.logger.error.assert_called_with(
                "Error finding image: Element not found")
    ...
    def test_collect_data_dog_validation_logic(self):
        ...
        with patch('scrapers.pets_in_turkey.dogs_scraper.BaseScraper.__init__'):
            ...
            valid_check = (
                "I'm " in container_text_valid
                and "Breed" in container_text_valid
                and ("Age" in container_text_valid or "Sex" in container_text_valid)
            )
            assert valid_check is True

            # Invalid container should fail validation
            invalid_check = (
                "I'm " in container_text_invalid
                and "Breed" in container_text_invalid
                and ("Age" in container_text_invalid or "Sex" in container_text_invalid)
            )
            ...
            assert not (
                invalid_dog_data and "name" in invalid_dog_data and invalid_dog_data["name"])
    ...
    def test_collect_data_invalid_dog_filtered(self):
        ...
        with patch('scrapers.pets_in_turkey.dogs_scraper.BaseScraper.__init__'):
            ...
            scraper._parse_special_case = Mock(
                return_value={"breed": "Unknown"})
    ...
    def test_weight_to_size_standardization(self):
        ...
        with patch('scrapers.pets_in_turkey.dogs_scraper.BaseScraper.__init__'):
            ...
            for weight_text, expected_size in test_cases:
                ...
                assert processed_data["size"] == expected_size, \
                    f"Weight {weight_text} should map to size {expected_size}"
    ...
    def test_age_text_standardization(self):
        ...
        with patch('scrapers.pets_in_turkey.dogs_scraper.BaseScraper.__init__'):
            ...
            for raw_age, expected_age in test_cases:
                ...
                assert processed_data["age_text"] == expected_age, \
                    f"Age text '{raw_age}' should be standardized to '{expected_age}'"
    ...
    def test_breed_standardization_integration(self):
        ...
        with patch('scrapers.pets_in_turkey.dogs_scraper.BaseScraper.__init__'):
            ...
            for raw_breed, expected_breed in test_cases:
                ...
                # standardization
                assert processed_data["breed"].strip() != "", \
                    f"Breed '{raw_breed}' should not be empty after processing"
                assert isinstance(processed_data["breed"], str), \
                    f"Breed should be a string, got {type(processed_data['breed'])}"

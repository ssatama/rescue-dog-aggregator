...
def get_embedded_enhanced_rules() -> Dict:
    ...
    return {
        ...
        "breed_specific_mappings": {
            ...
            "pattern_mappings": {
                "mixed breed": {
                    "keywords": ["cross", "crossbreed", "mixed", "mix"],
                    "target": "Mixed Breed",
                },
                "labrador": {
                    "keywords": ["labrador mix", "lab mix", "labrador-mix"],
                    "target": "Labrador Retriever Mix",
                },
                "german shepherd": {
                    "keywords": ["german shepherd mix", "gsd mix", "shepherd mix"],
                    "target": "German Shepherd Mix",
                },
            },
        },
...
class EnhancedBreedStandardizer:
    ...
    def apply_breed_specific_mappings(
        ...
        if processed_text in exact_mappings:
            ...
            return (
                target,
                self._get_breed_group(target),
                self._estimate_size_from_breed(target),
            )

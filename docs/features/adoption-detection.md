...
**Sitemaps** are generated by the frontend (`frontend/src/app/sitemap-dogs.xml/`),
backed by the `sitemap_quality_filter` parameter on `/api/animals`.
...
**AdoptedCelebration** (`frontend/src/components/dogs/AdoptedCelebration.tsx`)
- Purple gradient celebration banner
- Emotional messaging about finding forever home
- Explains why page remains active

**DogStatusBadge** (`frontend/src/components/dogs/DogStatusBadge.tsx`)
...
- [Scraper System](../technical/scraper-architecture.md)

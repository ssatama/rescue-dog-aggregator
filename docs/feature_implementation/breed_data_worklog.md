...
- [ ] Add standardizer instance to __init__
- [ ] Add use_unified_standardization feature flag
- [ ] Implement process_animal() method
- [ ] Update save_animal() to use standardization
- [ ] Add logging for standardization events
- [ ] Test base scraper changes
